...
const PROMO_HOST = 'gelato.education';
...
const PROMO_CTA_BASE =
  'inline-flex h-11 items-center gap-1.5 rounded-xl px-6 text-[15px] transition-all duration-200 hover:-translate-y-0.5 motion-reduce:hover:translate-y-0 cursor-pointer';
        ...
        <div className="relative max-w-xl space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-3 pt-3">
            <PromoCta
              ...
              look={PROMO_CTA_GOOSE}
              courseSlug="it-vibecoding"
              courseTitle="ИИ + Кодовая база (Инженерный вайбкодинг)"
            />
          </div>
        </div>
      </div>
