  ...
  tariffs: [
    {
      ...
      features: [
        ...
        'Практика: учебный репозиторий или свой проект',
        'Шаблоны CLAUDE.md, rules, skills, конфигов линтеров и тестов',
        'Приватность: доступ к вашему репозиторию не нужен, код остаётся у вас',
      ],
      excludedFeatures: ['Без личной проверки заданий и чата'],
    },
    {
      id: 'vibecoding_stream',
      title: 'С поддержкой Эмиля',
      description: 'Старт 14 сентября: 3 недели практики с личным разбором задач',
      price: 19900,
      oldPrice: 27900,
      periodDays: 60,
      months: 2,
      ...
      features: [
        ...
        'Личный разбор вашего кода, архитектуры и домашек',
        '3 недели личной поддержки автора в Telegram',
        'Практика на учебном стенде или в вашем рабочем репо',
        'NDA и приватность: секреты и репозиторий не передаются, смотрим только точечные диффы',
      ],
      specialOffer: {
