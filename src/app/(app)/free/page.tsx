...
export const metadata: Metadata = {
  title: 'Бесплатные уроки по работе с ИИ для новичков — GELATO',
  description:
    'Открытые уроки для тех, кто только начинает: как объяснить задачу ИИ, зачем нужен контекст, куда уходят лимиты и почему модель выдумывает ответы. Без опыта и без оплаты.',
