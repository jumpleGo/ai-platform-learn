  ...
  const faqItems = isAgents
    ...
    : [
        ...
        },
        {
          ...
          answer: 'В тарифе с поддержкой Эмиль **проверяет домашние задания**, а у вас есть 3 недели личного чата. Можно задавать любые вопросы по ходу обучения: если что-то не получается, не работает или вы хотите понять, правильно ли всё сделали.',
        },
        {
        ...
        <section className="animate-rise space-y-6 pt-4">
          ...
          <div className="space-y-3">
            ...
            <details className="group rounded-3xl border-2 border-brand-navy/15 bg-card p-5 sm:p-6 shadow-[0_4px_0_0_rgba(16,38,71,0.06)] transition-all hover:border-brand-navy open:shadow-[0_6px_0_0_rgba(16,38,71,0.1)]">
              ...
              <div className="mt-3.5 border-t border-dashed border-brand-navy/10 pt-3.5 text-[17px] font-medium leading-relaxed sm:text-lg text-brand-charcoal/90">
                <RichText text="В тарифе с поддержкой Эмиль **проверяет домашние задания**, а у вас есть 3 недели личного чата. Можно задавать любые вопросы, которые возникают по ходу обучения. Если что-то не получается, непонятно, как поступить, не работает настройка или вы хотите понять, правильно ли всё сделали, — пишете в чат." />
              </div>
            </details>
